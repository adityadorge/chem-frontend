<script lang="ts">
  ...
  <!-- Card grid container -->
  <div
    class="relative flex flex-wrap justify-center gap-2 bg-white rounded-2xl pt-4 pb-20"
  >
    <section class="w-full">
      ...
      >
        ...
        >
          ...
          <div
            class="flex items-center justify-center w-full max-w-md mx-auto mt-4"
          >
            <a
              href="/testing"
            ...
            >
              <Rocket
                size={20}
                aria-hidden="true"
                class="text-[#1746a2] mr-3"
              />
              <span class="flex-1 text-gray-500 text-base font-medium text-left"
