<script lang="ts">
  ...
  // When a category is selected, update the page title
  $: pageTitle = selectedCategory ? selectedCategory.category_name : "Testing";
...
<section class="testing-hero">
  ...
  <div class="hero-inner">
    ...
    <h1
      class="max-w-2xl mx-auto mb-4 text-center text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl"
    >
      {pageTitle}
    </h1>
    <p
      class="max-w-2xl mb-6 mx-auto text-center font-light text-white-500 lg:mb-8 md:text-lg lg:text-xl dark:text-white-400"
    >
      {pageSubtitle}
    </p>
    ...
    >
      ...
      <div class="filters-row">
        ...
        <div class="pill pill-input">
          ...
          >
            <path
              d="M21 21l-4.3-4.3m1.8-5a6.5 6.5 0 11-13 0 6.5 6.5 0 0113 0z"
              fill="none"
              stroke="#9aa0a6"
              stroke-width="2"
              stroke-linecap="round"
        ...
        <!-- Button -->
        <button class="pill-btn" type="button" on:click={showResults}
          >Show results</button
        >
      </div>
    </div>
...
<section class="content-section">
  <div class="content-container">
        ...
        {#if latestContent.length}
          {#key latestIndex}
            <article class="latest-card">
              <img
                class="latest-img"
                src={latestContent[latestIndex].image}
                alt=""
              />
              <div class="latest-body">
                ...
                <p class="latest-desc">
                  {latestContent[latestIndex].description}
                </p>
        ...
        <div class="subscribe-card" role="region" aria-label="Subscribe">
          <div class="sub-left">
            ...
            <div class="sub-copy">
              ...
              <p class="sub-desc">
                to get workplace tips delivered straight to your inbox
              </p>
            </div>
          </div>
    ...
    >
      <span class="content-divider__text"
        >select from wide variety of categories</span
      >
    </div>
...
<style>
  ...
  .cards-container {
    max-width: 1360px; /* was 1120px — give cards more room */
    margin: 0 auto;
    padding: 0 16px 60px;
  }

  /* Tests view toggle: hidden by default, shown ≥700px */
  .tests-toolbar {
    display: none;
    gap: 8px;
