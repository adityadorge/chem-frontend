  ...
  const fallbackItems: ServiceCard[] = [
    {
      ...
      description:
        "Our platform provides a seamless doorstep-to-lab service—simply book your test online, and we’ll handle pickup, secure delivery, compliance, and regulatory paperwork for you. ",
