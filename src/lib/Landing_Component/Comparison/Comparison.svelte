<script lang="ts">
  ...
  type FeatureRow = { label: string; a: boolean; b: boolean };
  type Section = {
    title: string;
    description: string;
    image: string;
  ...
  <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
    <header class="text-center mb-8 sm:mb-12">
      <h1 class="text-4xl sm:text-5xl font-extrabold tracking-tight text-gray-900">
        ...
        <span class="text-[#174698] pencil-underline">Research Made Modern</span>
      </h1>
    </header>
    ...
    {#each sections as s}
      <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
        ...
        <div class="text-gray-600 sm:text-lg">
          ...
          <p class="mb-8 font-light lg:text-xl">
            ...
            <div class="pt-8 my-7 border-t overflow-x-auto rounded-lg bg-gray-50">
                  ...
                  {#each s.features as f}
                    <tr>
                      ...
                      <td class="px-6 text-center">
                        {#if f.a}
                          <svg class="inline w-5 h-5 text-emerald-500" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                          </svg>
                          <span class="sr-only">Available</span>
                        {:else}
                          <svg class="inline w-5 h-5 text-rose-500" viewBox="0 0 24 24" fill="none">
